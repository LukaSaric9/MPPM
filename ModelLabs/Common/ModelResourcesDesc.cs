...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{
            typeIdsInInsertOrder.Add(ModelCode.CONDEQ);
            typeIdsInInsertOrder.Add(ModelCode.TERMINAL);
            typeIdsInInsertOrder.Add(ModelCode.REG_CONTROL);
		...
		{			
            ...
            notSettablePropertyIds.Add(ModelCode.TAPCHANGER_TS);
            notSettablePropertyIds.Add(ModelCode.DAYTYPE_SDTS);
            notSettablePropertyIds.Add(ModelCode.SEASON_SDTS);
            notSettablePropertyIds.Add(ModelCode.REG_CONTROL_RS);
        }
