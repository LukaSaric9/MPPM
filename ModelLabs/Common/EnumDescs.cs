...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			property2enumType.Add(ModelCode.REG_CONTROL_MONITPHASE, typeof(PhaseCode));
			property2enumType.Add(ModelCode.BASINT_SCHEDULE_V1MULT, typeof(UnitMultiplier));
			property2enumType.Add(ModelCode.BASINT_SCHEDULE_V1UNIT, typeof(UnitSymbol));
            property2enumType.Add(ModelCode.BASINT_SCHEDULE_V2MULT, typeof(UnitMultiplier));
            property2enumType.Add(ModelCode.BASINT_SCHEDULE_V2UNIT, typeof(UnitSymbol));
			property2enumType.Add(ModelCode.REG_CONTROL_MODE, typeof(RegulatingControlModeKind));
